...
<p align="center">
  <a href="https://labex.io/pt/courses/python-for-security-operations">
    <img src="https://course-cover.labex.io/python-for-security-operations.png?lang=pt" alt="Python para Operações de Segurança">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/python-for-security-operations)

## Exercícios

|   Índice | Nome                                      | Dificuldade   | Prática                                                                                                                                                  |
|----------|-------------------------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Fundamentos de Redes com Python           | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-python-networking-basics-656210?course=python-for-security-operations'>Iniciar Lab</a>           |
|        2 | Interagindo com Aplicações Web (Requests) | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-interacting-with-web-apps-requests-656209?course=python-for-security-operations'>Iniciar Lab</a> |
|        3 | Automatizando a Análise de Logs           | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-automating-log-analysis-656208?course=python-for-security-operations'>Iniciar Lab</a>            |
|        4 | Desafio de Automação de Segurança         | Intermediário | <a target='_blank' href='https://labex.io/pt/labs/linux-security-automation-challenge-656207?course=python-for-security-operations'>Iniciar Desafio</a>  |
